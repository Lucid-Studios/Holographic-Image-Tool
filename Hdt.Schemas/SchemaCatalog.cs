...
public static class SchemaCatalog
{
    private static readonly IReadOnlyDictionary<string, SchemaDefinition> Definitions =
        new Dictionary<string, SchemaDefinition>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [BuildKey("oan.hopng_universe_layer", "0.1.0")] = new("oan.hopng_universe_layer", "0.1.0", string.Empty, false, 2, Array.Empty<string>()),
            [BuildKey("oan.hopng_gluing_manifest", "0.1.0")] = new("oan.hopng_gluing_manifest", "0.1.0", string.Empty, false, 2, Array.Empty<string>()),
            [BuildKey("oan.hopng_projection_rules", "0.1.0")] = new("oan.hopng_projection_rules", "0.1.0", string.Empty, false, 2, Array.Empty<string>()),
            [BuildKey("oan.hopng_legibility_profile", "0.1.0")] = new("oan.hopng_legibility_profile", "0.1.0", string.Empty, false, 2, Array.Empty<string>()),
