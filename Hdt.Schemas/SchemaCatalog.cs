...
public static class SchemaCatalog
{
    private static readonly IReadOnlyDictionary<string, SchemaDefinition> Definitions =
        new Dictionary<string, SchemaDefinition>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [BuildKey("oan.hopng_event_slice", "0.1.0")] = new(
                "oan.hopng_event_slice",
                "0.1.0",
                "Hdt.Schemas.Schemas.oan.hopng_event_slice.v0.1.0.json",
                true,
                3,
                ["schema", "schemaVersion", "artifactId", "observedSet", "slices"]),
            [BuildKey("oan.hopng_phase_slice", "0.1.0")] = new(
                "oan.hopng_phase_slice",
                "0.1.0",
                "Hdt.Schemas.Schemas.oan.hopng_phase_slice.v0.1.0.json",
                true,
                3,
                ["schema", "schemaVersion", "artifactId", "slices"]),
            [BuildKey("oan.hopng_phase_policy", "0.1.0")] = new(
                "oan.hopng_phase_policy",
                "0.1.0",
            ...
            [BuildKey("oan.hopng_optical_channels", "0.1.0")] = new(
                ...
                "0.1.0",
                "Hdt.Schemas.Schemas.oan.hopng_optical_channels.v0.1.0.json",
                true,
                3,
                ["schema", "schemaVersion", "artifactId", "requiredChannels", "reservedChannels", "channels"]),
            [BuildKey("oan.hopng_perspectival_engram", "0.1.0")] = new(
                "oan.hopng_perspectival_engram",
                "0.1.0",
                "Hdt.Schemas.Schemas.oan.hopng_perspectival_engram.v0.1.0.json",
                true,
                4,
                ["schema", "schemaVersion", "artifactId", "workingIntentState", "intentClassification", "supportOnly", "evidenceClass", "claimSurface", "supportShape", "provenanceBasis", "constructorSupportStatus", "inspectionPosture", "phase5HandoffReady", "rootFormId", "rootCoherenceStatus", "rootCoherenceSignals", "validationQuestions", "protectedEvidenceRefs"]),
            [BuildKey("oan.hopng_participatory_engram", "0.1.0")] = new(
                "oan.hopng_participatory_engram",
                "0.1.0",
                "Hdt.Schemas.Schemas.oan.hopng_participatory_engram.v0.1.0.json",
                true,
                4,
                ["schema", "schemaVersion", "artifactId", "workingIntentState", "intentClassification", "supportOnly", "evidenceClass", "claimSurface", "supportShape", "provenanceBasis", "constructorSupportStatus", "inspectionPosture", "phase5HandoffReady", "branchSetId", "branchCoherenceStatus", "branchCoherenceSignals", "participantBranches", "validationQuestions", "protectedEvidenceRefs"]),
