    ...
    private static readonly IReadOnlyDictionary<string, SchemaDefinition> Definitions =
        new Dictionary<string, SchemaDefinition>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [BuildKey("oan.hopng_phase_policy", "0.1.0")] = new(
                ...
                true,
                3,
                ["schema", "schemaVersion", "artifactId", "rawCadenceMs", "eventGroupingMode", "eventGroupingSizeRawSlices", "phaseWindowMode", "phaseWindowSizeEventSlices", "comparisonHorizonRawSlices", "aggregationPolicies", "primeSafeInspectionMode", "privilegedInspectionMode"]),
