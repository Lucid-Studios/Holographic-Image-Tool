...
The Holographic Data Tool (HDT) is a Windows-first CLI for creating, validating, and inspecting `.hopng` artifacts. Phase 1 is implemented end to end, and Phase 2 is implemented as the current operator-ready layer: deterministic manifests, lawful sidecars, Ed25519 trust material, Prime-safe inspection, relational universes, governed merge derivation, and artifact-to-artifact comparison.
...
Supported Phase 2 operator commands:
